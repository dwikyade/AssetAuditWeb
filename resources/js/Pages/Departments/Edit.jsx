            ...
            <div className="p-6 max-w-2xl mx-auto space-y-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">Perbarui data departemen <span className="font-semibold text-indigo-600">{department.name}</span>.</p>
                    </div>
                </div>

                {department.assets_count > 0 && (
                    <div className="bg-blue-50 border border-blue-200 text-blue-800 p-3 rounded-lg text-sm flex gap-2">
                        <span>ℹ️</span>
                        <span>Departemen ini memiliki <strong>{department.assets_count} aset</strong> terdaftar.</span>
                    </div>
                )}
